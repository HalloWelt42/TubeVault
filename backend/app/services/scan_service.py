"""
TubeVault – Scan Service v1.9.16
...
# YouTube-ID Patterns (erweitert — yt-dlp, Klammern, Unterstrich, nur-ID)
YT_ID_PATTERNS = [
    re.compile(r'\[([a-zA-Z0-9_-]{11})\]'),           # [dQw4w9WgXcQ]
    re.compile(r'\(([a-zA-Z0-9_-]{11})\)'),            # (dQw4w9WgXcQ)
    re.compile(r'-([a-zA-Z0-9_-]{11})\.f\d+\.'),       # -id.f137.mp4
    re.compile(r'-([a-zA-Z0-9_-]{11})\.[a-zA-Z0-9]+$'),# -id.mp4
    re.compile(r'_([a-zA-Z0-9_-]{11})\.[a-zA-Z0-9]+$'),# _id.mp4
    re.compile(r'^([a-zA-Z0-9_-]{11})\.[a-zA-Z0-9]+$'),# id.mp4
]
